...
class AppUploadProductImagePickedErrorState extends AppStates {}

class AppUploadProductImagePickedSuccessState extends AppStates {}
...
class AppAddSizeState extends AppStates {}

class AppRemoveSizeState extends AppStates {}

class AppAddToFavoritesSuccessState extends AppStates {}

class AppAddToFavoritesLoadingState extends AppStates {}

class AppAddToFavoritesErrorState extends AppStates {}

class AppRemoveFromFavoriteSuccessState extends AppStates {}

class AppRemoveFromFavoriteLoadingState extends AppStates {}

class AppRemoveFromFavoriteErrorState extends AppStates {}
...
class AppGetFavoriteScreenSuccessState extends AppStates {}

class AppGetFavoriteScreenErrorState extends AppStates {}

class AppAddToFavoriteScreenSuccessState extends AppStates {}
...
class AppUpdateAccountErrorState extends AppStates {}

class AppChangeSelectedSizeState extends AppStates {}
...
class AppRemoveFromCartLoadingState extends AppStates {}
...
class AppIncrementErrorState extends AppStates {}

class AppIncrementSuccessState extends AppStates {}

class AppIncrementLoadingState extends AppStates {}

class AppDecreaseErrorState extends AppStates {}

class AppDecreaseSuccessState extends AppStates {}

class AppDecreaseLoadingState extends AppStates {}

class AppGetCartScreenSuccessState extends AppStates {}

class AppGetCartScreenLoadingState extends AppStates {}

class AppGetCartScreenErrorState extends AppStates {}

class AppGetCartProductModelSuccessState extends AppStates {}
